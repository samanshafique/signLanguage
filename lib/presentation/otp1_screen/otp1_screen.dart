...
import 'provider/otp1_provider.dart';

class Otp1Screen extends StatefulWidget {
  const Otp1Screen({Key? key})
      : super(
          key: key,
        );

  @override
  Otp1ScreenState createState() => Otp1ScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => Otp1Provider(),
      child: Otp1Screen(),
    );
  }
}

class Otp1ScreenState extends State<Otp1Screen> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Selector<Otp1Provider, TextEditingController?>(
                            selector: (
                              context,
                              provider,
                            ) =>
