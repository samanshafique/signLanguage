...
import 'provider/otp_screen_two_provider.dart';

class OtpScreenTwoScreen extends StatefulWidget {
  const OtpScreenTwoScreen({Key? key})
      : super(
          key: key,
        );

  @override
  OtpScreenTwoScreenState createState() => OtpScreenTwoScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => OtpScreenTwoProvider(),
      child: OtpScreenTwoScreen(),
    );
  }
}

class OtpScreenTwoScreenState extends State<OtpScreenTwoScreen> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Selector<OtpScreenTwoProvider,
  ...
  Widget _buildTwoHundred(BuildContext context) {
    return Consumer<OtpScreenTwoProvider>(
