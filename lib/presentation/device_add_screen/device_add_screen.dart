...
import 'provider/device_add_provider.dart';

class DeviceAddScreen extends StatefulWidget {
  const DeviceAddScreen({Key? key})
      : super(
          key: key,
        );

  @override
  DeviceAddScreenState createState() => DeviceAddScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => DeviceAddProvider(),
      child: DeviceAddScreen(),
    );
  }
}

class DeviceAddScreenState extends State<DeviceAddScreen> {
        ...
        body: Form(
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Selector<DeviceAddProvider, TextEditingController?>(
                    selector: (
                      context,
                      provider,
                    ) =>
