...
import 'provider/device_manage_one_provider.dart';

class DeviceManageOneScreen extends StatefulWidget {
  const DeviceManageOneScreen({Key? key})
      : super(
          key: key,
        );

  @override
  DeviceManageOneScreenState createState() => DeviceManageOneScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => DeviceManageOneProvider(),
      child: DeviceManageOneScreen(),
    );
  }
}

class DeviceManageOneScreenState extends State<DeviceManageOneScreen> {
  @override
  void initState() {
    super.initState();
  }
        ...
        body: SizedBox(
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Selector<DeviceManageOneProvider, TextEditingController?>(
                    selector: (
                      context,
                      provider,
                    ) =>
