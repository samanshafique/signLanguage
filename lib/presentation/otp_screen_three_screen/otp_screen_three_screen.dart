...
import 'provider/otp_screen_three_provider.dart';

class OtpScreenThreeScreen extends StatefulWidget {
  const OtpScreenThreeScreen({Key? key})
      : super(
          key: key,
        );

  @override
  OtpScreenThreeScreenState createState() => OtpScreenThreeScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => OtpScreenThreeProvider(),
      child: OtpScreenThreeScreen(),
    );
  }
}

class OtpScreenThreeScreenState extends State<OtpScreenThreeScreen> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Selector<OtpScreenThreeProvider,
  ...
  Widget _buildTwoHundred(BuildContext context) {
    return Consumer<OtpScreenThreeProvider>(
