...
import 'provider/add_device_provider.dart';

class AddDeviceScreen extends StatefulWidget {
  const AddDeviceScreen({Key? key})
      : super(
          key: key,
        );
...
class AddDeviceScreenState extends State<AddDeviceScreen> {
  ...
  Widget _buildName(BuildContext context) {
    return Selector<AddDeviceProvider, TextEditingController?>(
      selector: (
        context,
        provider,
      ) =>
    ...
    return Selector<AddDeviceProvider, TextEditingController?>(
      selector: (
        ...
        provider,
          ...
          provider.tenController,
      builder: (context, tenController, child) {
        return CustomTextFormField(
