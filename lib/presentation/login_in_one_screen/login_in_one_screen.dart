...
import 'provider/login_in_one_provider.dart';

class LoginInOneScreen extends StatefulWidget {
  const LoginInOneScreen({Key? key})
      : super(
          key: key,
        );

  @override
  LoginInOneScreenState createState() => LoginInOneScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => LoginInOneProvider(),
      child: LoginInOneScreen(),
    );
  }
}

class LoginInOneScreenState extends State<LoginInOneScreen> {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 1.h),
                            child: Selector<LoginInOneProvider,
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 1.h),
                            child: Consumer<LoginInOneProvider>(
  ...
  Widget _buildKeepmeloggedin(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: 1.h),
      child: Selector<LoginInOneProvider, bool?>(
        selector: (
          context,
          provider,
        ) =>
        ...
        builder: (context, keepmeloggedin, child) {
          return CustomCheckboxButton(
            ...
            onChange: (value) {
              context.read<LoginInOneProvider>().changeCheckBox1(value);
            },
          );
        },
      ),
